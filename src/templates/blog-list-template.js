...
export default class BlogList extends React.Component {
  render() {
    ...
    const prevPage =
      currentPage - 1 === 1 ? `/posts/1` : `/posts/${currentPage - 1}`
            ...
            return (
              <div className={blogListStyles.cards} key={node.id}>
                <figure className={blogListStyles.evocImg}>
                  ...
                  <figcaption>
                    <div
                      className={`${blogListStyles.overlay} ${blogListStyles.icons}`}
                    >
                      <a
                        className={blogListStyles.icon}
                        href={
                          node.frontmatter.screenshot.childImageSharp.original
                            .src
                        }
                        target="_blank"
                        rel="noreferrer"
