...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://raider.io/api/v1/guilds/profile?region=eu&realm=aegwynn&name=zero&fields=raid_progression%2Craid_rankings`
    )
      ...
      .then(resultData => {
        ...
        setRealmRank(
          resultData.raid_rankings["nyalotha-the-waking-city"].mythic.realm
        )
        setProgression(
          resultData.raid_progression["nyalotha-the-waking-city"].summary
        )
  ...
  return (
    <div className="sidebar">
      ...
      <Recruit />
      <a
        href="https://www.wowprogress.com/guild/eu/aegwynn/Zero"
        target="_blank"
        rel="noreferrer"
        className={sidebarStyles.rankLinkWrapper}
      >
