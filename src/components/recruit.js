...
const Recruit = () => {
    ...
    return (
        <div className="recruit">
            {getOpenStatus() && <span className={sidebarStyles.title}>zero sucht</span> }
            {/* <div className={sidebarStyles.allianceLogo}><span className="icon-alliance"> </span></div> */}
            ...
            {getStatus("dh") && 
                ...
                <>
                    ...
                    <span>
                        ...
                        />
                        <Image
                        src='images/spec/rogue/subtlety.png'
